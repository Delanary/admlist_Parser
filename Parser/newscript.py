...
if len(sys.argv)<2 or sys.argv[1] == '--help' :
    ...
    cursor.execute("""CREATE TABLE students
                      (surname text, name text, patronymic text, certificate text,
...
#                print(type(tds))
                ...
                certificate_status = str(tds[4])[19:-5]
...
#                    print(tmp)
                    ...
                    for i in range(3-len(Full_name)):
                        Full_name.append(' ')
                Full_name+=[certificate_status, Univ_name, Faculty_name]
                for i in Full_name:
                    i.replace(' ', '')
                try:
